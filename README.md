...
- `Createrecommendation` - should create a new recommendation for a current user. A shape of data send by a client application to this function can be found in the `CreateRecommendationRequest.ts` file
